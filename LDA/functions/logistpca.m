...
%
% Optional parameters:
% v - initialization for faster convergence  (optional)
% show - if>0 will show first two dimensions  (optional)
% lambda - regularization constant for weight decay for the case that your
...
% relative to the largest eigenvalue of the SVD. All dimension with
